...
function CostForm(props) {
    ...
    const kontenerArCalc = () => {
      ...
      if(zipFound>=0){
        containerCost = zoneCosts[zipFound][container] + materialCost[material] + " Ft / konténer";
    ...
    function closeModal(e) {
      if(e.target.className==="modal-bg" || e.target.className==="modal-close")
      {
      setModalVisible(false);
      }
    }
      ...
      return (
        <div className="costform-container">
            <form className="costform-form" onSubmit={handleSubmit}>
                ...
                <label>
                Konténer
                <select className='footer-select' name="kontener" value={container} onChange={handleContainerChange}>
                ...
                <label>
                Szállítandó anyag
                <select className='footer-select' name="anyag" value={material} onChange={handleMaterialChange}>
                ...
                <button type="submit" className="cost-form-button">ÁRAT</button>
                <button className="cost-form-button" type="button" onClick={closeCostForm}>BEZÁR</button>
              </form>
              <div className={isModalVisible ? 'modal modal--isVisible' : 'modal'}>
                <div className='modal-bg' onClick={closeModal}>
                  <div className='modal-box'>
                  <button className='modal-close' type='button' onClick={closeModal}>BEZÁR</button>
                    <h2>A legjobb ár!</h2>
